...
class TensorBoardConfig(BaseConfig):
    ...
    enabled: Annotated[
        bool,
        Field(
            description="Whether to write TensorBoard event files.",
        ),
    ] = False
    ...
    log_dir: Annotated[
        Path | None,
        Field(
            description="Directory to write TensorBoard event files to. Defaults to <output_dir>/tensorboard.",
        ),
    ] = None
    ...
    flush_secs: Annotated[
        ...
        Field(
            ge=1,
            description="How often, in seconds, TensorBoard event files are flushed to disk.",
        ),
    ] = 10
