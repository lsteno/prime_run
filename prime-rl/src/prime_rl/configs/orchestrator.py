...
class TraceExportConfig(BaseConfig):
    """Configures human-readable rollout trace export."""

    enabled: Annotated[
        bool,
        Field(description="Whether to export human-readable rollout traces after each step."),
    ] = False

    output_dir: Annotated[
        Path | None,
        Field(description="Optional directory to write readable trace files to. Defaults to <output_dir>/traces."),
    ] = None

    include_segments: Annotated[
        bool,
        Field(description="Whether to include segment summaries in the exported trace files."),
    ] = True

    include_metrics: Annotated[
        bool,
        Field(description="Whether to include rollout metrics in the exported trace files."),
    ] = True
